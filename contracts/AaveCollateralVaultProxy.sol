...
contract AaveCollateralVault is ReentrancyGuard {
  ...
  address public constant aave = address(0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5);
  uint public model = 2;
...
address public constant aave = address(0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5);
address public constant link = address(0x9326BFA02ADD2366b30bacB125260Af641031331);
